...
These guides assume you have already installed Spring-Hex and completed the Quick Start tutorial. If you haven't done so, please refer to the [Installation]({% link getting-started/installation.md %}) and [Quick Start]({% link getting-started/quick-start.md %}) sections first.
